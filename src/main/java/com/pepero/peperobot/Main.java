...
import com.pepero.peperobot.uci.UCIParse;
...
public class Main {
    ...
    static void runBench() {
        ...
        for (String fenCommand : benchFens) {
            fenCommand = "position fen " + fenCommand;
            UCIParse.parsePosition(UCIManager.chessboardUCI, fenCommand);

            Search.searchPosition(UCIManager.chessboardUCI, depth);
        ...
        System.out.println(totalNodes + " nodes " + nps + " nps");
    }
}
